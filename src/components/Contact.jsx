    ...
    <div className="contact" id="contact">
      ...
      <section className="contact-section">
        ...
        <article className="contact-icons">
          <a href="mailto: arekcichocki95@gmail.com" rel="noreferrer" target="_blank">
            <AiFillMail className="contact-icons-item"/>
          </a>
          <a href="https://www.linkedin.com/in/arekcichocki" rel="noreferrer" target="_blank">
            <AiFillLinkedin className="contact-icons-item"/>
          </a>
          <a href="https://github.com/ArexSpeed" rel="noreferrer" target="_blank">
